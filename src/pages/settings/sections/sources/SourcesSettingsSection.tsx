...
import type { SourceMutationVariables } from './types/sourceSettingsTypes';
import {
  getSensorTypeLabel,
  getSourceStatusLabel,
  sortInventoryItems,
  sortSources,
} from './utils/sourceSettingsUtils';

const SOURCES_QUERY_KEY = sourcesQueryKeys.colorRegistry;
const SOURCES_INVENTORY_QUERY_KEY = sourcesQueryKeys.inventory;
...
export default function SourcesSettingsSection() {
