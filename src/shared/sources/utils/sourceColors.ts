import type { Source, SourceColorInput } from '../types';
...
{/* Fonction qui donne la couleur d'une source en fonction de son id, de son nom et d'un registre de couleurs */}
