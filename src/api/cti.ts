...
export async function fetchCtiEnrichment(
  provider: CtiEnrichmentProvider,
  ipAddress: string,
): Promise<CtiEnrichmentResponse> {
  return apiClient.get<CtiEnrichmentResponse>(`/api/cti-enrichment/${provider}`, {
